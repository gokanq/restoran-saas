...
export class TableServiceController {
  ...
  createDiningArea(
    ...
    return this.tableService.createDiningArea(this.getRestaurantId(req), body);
  }
  ...
  createTable(
    ...
    return this.tableService.createTable(this.getRestaurantId(req), body);
  }
  ...
  reserveTable(
    ...
    return this.tableService.reserveTable(this.getRestaurantId(req), id, body);
  }

  @Post('tables/:id/clear-reservation')
  clearTableReservation(@Param('id') id: string, @Req() req: AuthenticatedRequest) {
    return this.tableService.clearTableReservation(this.getRestaurantId(req), id);
  }

  @Get('sessions/open')
  getOpenSessions(@Query('branchId') branchId: string, @Req() req: AuthenticatedRequest) {
    return this.tableService.getOpenSessions(this.getRestaurantId(req), branchId);
  }
  ...
  openSession(
    ...
    return this.tableService.openSession(this.getRestaurantId(req), req.user.id, body);
  }

  @Get('sessions/:id')
  getSessionById(@Param('id') id: string, @Req() req: AuthenticatedRequest) {
    return this.tableService.getSessionById(this.getRestaurantId(req), id);
  }
  ...
  addSessionItem(
    ...
    body: {
      ...
      note?: string;
      options?: SessionItemOptionBody[];
    },
    @Req() req: AuthenticatedRequest,
  ) {
    return this.tableService.addSessionItem(this.getRestaurantId(req), id, body);
  }
  ...
  patchSessionItem(
    ...
    return this.tableService.patchSessionItem(this.getRestaurantId(req), id, itemId, body);
  }

  @Post('sessions/:id/payment-pending')
  paymentPending(@Param('id') id: string, @Req() req: AuthenticatedRequest) {
    return this.tableService.setPaymentPending(this.getRestaurantId(req), id);
  }
  ...
  cancelSession(
    ...
    return this.tableService.cancelSession(this.getRestaurantId(req), id, body.reason);
  }
}
